...
st.sidebar.write("Скорости при 3 и 12 минути (можеш да ги променяш).")
...
st.divider()
st.caption("© onFlows • Линеен модел върху идеалните точки + r(s) от реални тестове. CS/W' от 3' и 12'.")
