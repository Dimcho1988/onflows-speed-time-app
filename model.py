...
def _ensure_sorted_pairs(pairs):
...
class PersonalModel:
    ...
    def v_personal(self, s_km):
        return self.r(s_km) * self.ideal.v_ideal(s_km)

    def t_personal(self, s_km):
    ...
    def distance_for_time(self, t_min, s_min=0.05, s_max=100.0, tol=1e-6, iters=100):
        lo, hi = s_min, s_max
